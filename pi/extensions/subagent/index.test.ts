...
async function testPromptFreeStableSubagentMetadata(): Promise<void> {
	...
	try {
		...
		const criticalContractTexts = [
			...
			"Omit model and thinking unless the user explicitly requests exact overrides",
			"omitted values inherit the current parent model and thinking level",
			"unavailable models are rejected rather than substituted",
